...
- [ ] M7.4 Обфускация в стиле Salamander (Hysteria): XOR-скрэмблинг датаграммы
      ключом из пароля сервера. Ноль лишних байт. Переключатель — «похоже на
      HTTP/3» и «не похоже ни на что» выигрывают в разных сетях.
