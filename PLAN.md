...
- [ ] M7.3 Список транспортов с автопереключением: пробовать по очереди,
      оставлять тот, по которому калитка M7.1 подтвердила обратный ход;
      запоминать удачный на сервер в config.json.
